...
extension UIScrollView {
    ...
    @discardableResult
    func contentInsetAdjustmentBehavior(_ contentInsetAdjustmentBehavior: UIScrollViewContentInsetAdjustmentBehavior) -> Self {
        self.contentInsetAdjustmentBehavior = contentInsetAdjustmentBehavior
        return self
    }

    @discardableResult
    func directionalLockEnabled(_ directionalLockEnabled: Bool) -> Self {
        isDirectionalLockEnabled = directionalLockEnabled
        return self
    }
    ...
    @discardableResult
    func indicatorStyle(_ indicatorStyle: UIScrollViewIndicatorStyle) -> Self {
        self.indicatorStyle = indicatorStyle
        return self
    }

    @discardableResult
    func decelerationRate(_ decelerationRate: CGFloat) -> Self {
        self.decelerationRate = decelerationRate
        return self
    }

    @discardableResult
    func indexDisplayMode(_ indexDisplayMode: UIScrollViewIndexDisplayMode) -> Self {
    ...
    @discardableResult
    func keyboardDismissMode(_ keyboardDismissMode: UIScrollViewKeyboardDismissMode) -> Self {
